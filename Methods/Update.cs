...
public class Update
{
    public static void UpdateTables()
    {
        ...
        //Заполнение таблиц заказов и продуктов
        if (context.Order.Count() == 0 && context.ProductAmount.Count() == 0 && context.Product.Count() == 0)
        {
            var webClient = new WebClient();

            List<Guid> productIds = new List<Guid>();
            for (int i = 0; i < 30; i++) productIds.Add(Guid.NewGuid());
            ...
            var products = new List<Product>()
            {
                new Product()
                {
                    Id = productIds[0], ProductArticle = "PMEZMH", MaxDiscount = 10, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/PMEZMH.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[1], ProductArticle = "BPV4MM", MaxDiscount = 13, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/BPV4MM.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[2], ProductArticle = "JVL42J", MaxDiscount = 1, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/JVL42J.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[3], ProductArticle = "F895RB", MaxDiscount = 17, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/F895RB.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[4], ProductArticle = "3XBOTN", MaxDiscount = 14, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/3XBOTN.jpeg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[5], ProductArticle = "3L7RCZ", MaxDiscount = 7, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/3L7RCZ.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[6], ProductArticle = "S72AM3", MaxDiscount = 9, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/S72AM3.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[7], ProductArticle = "2G3280", MaxDiscount = 16, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/2G3280.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[8], ProductArticle = "MIO8YV", MaxDiscount = 9, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/MIO8YV.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[9], ProductArticle = "UER2QD", MaxDiscount = 20, ProductImage = webClient.DownloadData("https://github.com/LizaPervokursnica/ProjectAssets/blob/main/StroyMaterialsImages/UER2QD.jpg?raw=true"),
                ...
                new Product()
                {
                    Id = productIds[10], ProductName = "Кирпич", ProductArticle = "MIO8YV", CurrentDiscount = 3, MaxDiscount = 10, AmountInStock = 26,
                ...
                new Product()
                {
                    Id = productIds[11], ProductArticle = "LPDDM4", MaxDiscount = 17, ProductName = "Штукатурка гипсовая",
                ...
                new Product()
                {
                    Id = productIds[12], ProductArticle = "LQ48MW", MaxDiscount = 16, ProductName = "Штукатурка гипсовая",
                ...
                new Product()
                {
                    Id = productIds[13], ProductArticle = "O43COU", MaxDiscount = 9, ProductName = "Шпаклевка",
                ...
                new Product()
                {
                    Id = productIds[14], ProductArticle = "M26EXW", MaxDiscount = 8, ProductName = "Клей для плитки, керамогранита и камня",
                ...
                new Product()
                {
                    Id = productIds[15], ProductArticle = "K0YACK", MaxDiscount = 9, ProductName = "Смесь цементно-песчаная",
                ...
                new Product()
                {
                    Id = productIds[16], ProductArticle = "ASPXSG", MaxDiscount = 17, ProductName = "Ровнитель",
                ...
                new Product()
                {
                    Id = productIds[17], ProductArticle = "ZKQ5FF", MaxDiscount = 13, ProductName = "Лезвие для ножа",
                ...
                new Product()
                {
                    Id = productIds[18], ProductArticle = "4WZEOT", MaxDiscount = 2, ProductName = "Лезвие для ножа",
                ...
                new Product()
                {
                    Id = productIds[19], ProductArticle = "4JR1HN", MaxDiscount = 3, ProductName = "Шпатель",
                ...
                new Product()
                {
                    Id = productIds[20], ProductArticle = "Z3XFSP", MaxDiscount = 19, ProductName = "Нож строительный",
                ...
                new Product()
                {
                    Id = productIds[21], ProductArticle = "I6MH89", MaxDiscount = 12, ProductName = "Валик",
                ...
                new Product()
                {
                    Id = productIds[22], ProductArticle = "83M5ME", MaxDiscount = 16, ProductName = "Кисть",
                ...
                new Product()
                {
                    Id = productIds[23], ProductArticle = "61PGH3", MaxDiscount = 2, ProductName = "Очки защитные",
                ...
                new Product()
                {
                    Id = productIds[24], ProductArticle = "GN6ICZ", MaxDiscount = 10, ProductName = "Каска защитная ",
                ...
                new Product()
                {
                    Id = productIds[25], ProductArticle = "Z3LO0U", MaxDiscount = 19, ProductName = "Очки защитные ",
                ...
                new Product()
                {
                    Id = productIds[26], ProductArticle = "QHNOKR", MaxDiscount = 6, ProductName = "Маска защитная",
                ...
                new Product()
                {
                    Id = productIds[27], ProductArticle = "EQ6RKO", MaxDiscount = 17, ProductName = "Подшлемник",
                ...
                new Product()
                {
                    Id = productIds[28], ProductArticle = "81F1WG", MaxDiscount = 1, ProductName = "Каска защитная",
                ...
                new Product()
                {
                    Id = productIds[29], ProductArticle = "0YGHZ7", MaxDiscount = 9, ProductName = "Очки защитные ",
            ...
            for (int i = 0; i < 10; i++) orderIds.Add(Guid.NewGuid());
            ...
            var orders = new List<Order>()
            {
                new Order()
                {
                    Id = orderIds[0], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.Close,
                ...
                new Order()
                {
                    Id = orderIds[1], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.New,
                ...
                new Order()
                {
                    Id = orderIds[2], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.Close,
                ...
                new Order()
                {
                    Id = orderIds[3], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.New,
                ...
                new Order()
                {
                    Id = orderIds[4], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.Close,
                ...
                new Order()
                {
                    Id = orderIds[5], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.New,
                ...
                new Order()
                {
                    Id = orderIds[6], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.Close,
                ...
                new Order()
                {
                    Id =orderIds[7], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.New,
                ...
                new Order()
                {
                    Id = orderIds[8], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.Close,
                ...
                new Order()
                {
                    Id = orderIds[9], DeliveryDate = new DateTime(2022, 5, 21), Statuse = Statuses.Close,
            ...
            {
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[0], Amount = 2, ProductId = productIds[0]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[0], Amount = 2, ProductId = productIds[1]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[1], Amount = 15, ProductId = productIds[2]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[1], Amount = 15, ProductId = productIds[3]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[2], Amount = 13, ProductId = productIds[4]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[2], Amount = 17, ProductId = productIds[5]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[3], Amount = 40, ProductId = productIds[6]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[3], Amount = 100, ProductId = productIds[7]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[4], Amount = 100, ProductId = productIds[8]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[4], Amount = 100, ProductId = productIds[9]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[5], Amount = 20, ProductId = productIds[10]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[5], Amount = 20, ProductId = productIds[11]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[6], Amount = 50, ProductId = productIds[12]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[6], Amount = 50, ProductId = productIds[13]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[7], Amount = 40, ProductId = productIds[14]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[7], Amount = 40, ProductId = productIds[15]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[8], Amount = 10, ProductId = productIds[16]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[8], Amount = 10, ProductId = productIds[17]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[9], Amount = 1, ProductId = productIds[18]},
                new ProductAmount(){Id = Guid.NewGuid(), OrderId = orderIds[9], Amount = 1, ProductId = productIds[19]},
            };
            #endregion
